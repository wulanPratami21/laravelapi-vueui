  ...
  <div class="card-body">
    <h5 class="card-title">Add Friends</h5>
      ...
      <div class="col-md-6">
        ...
        <input type="number" class="form-control" id="inputPassword4" v-model="friend.no_telp">
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control" id="inputAddress" placeholder="Masukan Alamat" v-model="friend.alamat">
...
export default {
  setup() {
    ...
    function store(){
      ...
      axios.post('http://127.0.0.1:800/api/friends', {
        nama: nama,
        no_telp: no_telp,
        alamat: alamat
      }).then(() => {
